...
const Testinomial = () => {
    return (
        <div id="Testinomial" className="h-auto w-screen  bg-image3 relative flex flex-col items-center justify-center min-h-screen bg-fixed bg-center bg-cover overflow-x-hidden"
            ...
            <div className="h-5/6 w-11/12 flex flex-col justify-center items-center inset-0 text-white m-auto bg-gray-900 bg-opacity-70 rounded-3xl">
                ...
                <div className=" md:top-0 h-auto w-11/12" >
