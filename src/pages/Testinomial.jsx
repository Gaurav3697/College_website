...
const Testinomial = () => {
    return (
        <div id="Testinomial" className="h-auto w-screen  bg-image3 relative flex flex-col items-center justify-center min-h-screen bg-fixed bg-center bg-cover overflow-x-hidden"
            ...
            <div className="h-screen w-11/12 flex flex-col justify-center items-center inset-0 text-white m-auto bg-gray-900 bg-opacity-70">
                ...
                <div className=" md:top-0 h-screen lg:h-auto w-11/12" >
                    <div className="flex justify-center m-auto uppercase text-xl md:text-3xl lg:text-5xl text-center">
                        <TestinomailCard />
                    </div>
                </div>
            </div>
